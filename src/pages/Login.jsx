...
+              </div>
+              <div>
+                <h1 className="text-3xl font-bold text-gray-900">CivicTrack</h1>
...
+                {isLogin 
+                  ? "Continue making a difference in your community. Sign in to track your issues and see the impact you're creating."
+                  : "Be part of a growing community of citizens working together to improve their neighborhoods and cities."
+                }
+              </p>
+            </div>
+            
...
+                "Connect with neighbors and local government",
...
+                  helperText={!isLogin ? "Use @gov.in for government accounts" : undefined}
+                  required
+                />
+
+                <Input
...
+                    type="button"
+                    onClick={toggleForm}
+                    className="ml-2 text-primary-600 hover:text-primary-700 font-medium hover:underline transition-colors"
+                  >
